      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-id">ID</th><th class="table-title">开放平台名称</th><th class="table-type">类别</th><th class="table-appid am-hide-sm-only">APPID</th><th class="table-date am-hide-sm-only">最后收到微信verify_ticket日期</th><th class="table-set">操作</th>
              </tr>
          </thead>
          <tbody>
